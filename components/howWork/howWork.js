                  ...
                  <List.Item>
                    <List.Content>
                      ...
                      <List.Description as="p">
                        Puedes llamarnos por teléfono <a className="item" href="tel:+34663333662">663333662</a>. Enviarnos un <a href="https://api.whatsapp.com/send?phone=+34663333662&text=Hola buscamos información">WhatsApp</a>  o contactarlos por nuestro <a href="#ContactForm">formulario</a>
                      </List.Description>
                    </List.Content>
                  </List.Item>
                </Grid.Column>
                ...
                <Grid.Column width={12}>
                  <List.Item>
                    <List.Content>
                      ...
                      <List.Description as="p">{t('Nos desplazamos al lugar donde necesitas la instalación y hacemos un estudio personalizado y sin coste para ti.')}</List.Description>
                    </List.Content>
                  </List.Item>
                </Grid.Column>
                <Grid.Column width={4}>
                ...
                <Grid.Column width={12}>
                  <List.Item>
                    <List.Content>
                      ...
                      <List.Description as="p">{t('Nuestro equipo especialista se encarga de colocar todos los dispositivos de seguridad y poner el sistema en funcionamiento.')}</List.Description>
                    </List.Content>
                  </List.Item>
                </Grid.Column>
                <Grid.Column width={4}>
